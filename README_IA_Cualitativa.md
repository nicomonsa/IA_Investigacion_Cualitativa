...
### 1. [📜 Prompt Canónico (Instrucciones para IA)](docs/Prompt_Canonico.md)
...
### 2. [📘 SOP (Procedimiento Operativo Estándar)](docs/SOP_Mapeo_Semantico.md)
...
1.  **Input:** Transcripciones de entrevistas (estructuradas/semiestructuradas).
2.  **Procesamiento:** Se aplica el *Prompt Canónico* para detectar lugares y fenómenos.
3.  **Estructuración:** Se clasifican los hallazgos en Ejes (A: Seguridad Vial, B: Uso, C: Apropiación) y Enfoques Transversales.
4.  **Spatial Join Lógico:** Se asigna cada hallazgo a una **IZ (Zona de Estudio)** específica (ej. Bosa Nova, Sierra Morena, Sumapaz).
5.  **Output:** Una matriz tabular lista para ser convertida en geometría (Puntos/Líneas) en software SIG (ArcGIS Pro / QGIS).
